   ...
   var ProfileTrackerData = [];
    ...
    MapProperties.forEach(function(element)
    {
       ...
       // TmpTotalSystemValue += parseFloat(element[24]); //Total system value
        ...
        //Oil
        if(element[9] == 1) //Limestone HF
        {
            TmpTotalOilHFTiles += element[3];
            TmpTotalOilHFProperties ++;
        }
        if(element[9] == -1) //Limestone UF
        {
...
async function FeatureProfileTracker()
{
    ...
    Output('<div id="TabsDiv" style="width: 100%;"><button id="Button_ProfileTracker_ProfileWorth" style="width: 33%; float:left; background:lightgrey; border: 1px solid black;">Profile worth</button><span style="width: 0.33%;float:left;">&nbsp;</span><button id="Button_ProfileTracker_TilesAndProperties" style="width: 33%;float:left; background:lightgrey; border: 1px solid black;">Tiles & properties</button><span style="width: 0.33%;float:left;">&nbsp;</span><!--<button id="Button_ProfileTracker_Resources" style="width: 33%; float:left; background:lightgrey; border: 1px solid black;">Resources</button>--><span style="width: 0.33%;float:left;">&nbsp;</span><button id="Button_ProfileTracker_Other" style="width: 33%; float:left; background:lightgrey; border: 1px solid black;">Other</button></div>');
    ...
    //Purchase worth, trading value, t1 total properties[38], t2 total properties
      ...
      //Create Charts
        Output('<div id="Tab_ProfileTracker_ProfileWorth" style="width:100%; height: 100%; display: block "><br><canvas id="Chart1" style="width:100%; height: 85%;"></canvas></div>',false);

        Output(`<div id="Tab_ProfileTracker_TilesAndProperties" style="width:100%; height: 100%; display: none; border-top: 3px solid darkgrey;  margin: 0.5% 0;">
        ...
        <br>
        <canvas id="Chart2" style="width:100%; height: 85%;"></canvas>
        </div>`,false);

        Output('<div id="Tab_ProfileTracker_Resources" style="width:100%; height: 100%; display: none"><br><canvas id="Chart3" style="width:100%; height: 85%;"></canvas></div>',false);
        Output('<div id="Tab_ProfileTracker_Other" style="width:100%; height: 100%; display: none"><br><canvas id="Chart4" style="width:100%; height: 85%;"></canvas></div>',false);



     //Delete entries functions
    Output(`<br><br><br><div id="Tab_ProfileTracker_DeleteButtons" style="width:100%; ">
        ...
        <div id="E2Multitool" style="border: 8px ridge green; background-color: rgb(186,222,186)">
              ...
              <div  style="width:100%;display: block; align-items: stretch; text-align:center; margin-top: -20px; font-size: 14px">
                  ...
                  <div  style="width:25%; text-align:center; float: left">
                       ...
                       <button id="Button_ProfileTracker" style="width:40%; border: 1px solid black; background:lightgrey">Profile tracker</button>
