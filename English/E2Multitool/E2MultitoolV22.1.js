...
async function FeatureJewelPricesT1(ClearOutputAtStart = 1)
    {
        ...
        var APIData = await GetRAPIData("bazaar/jewels/offers/?color_name=BLACK&max_price=100&min_price=0.00&page=1&sort_by=full_price&sort_dir=asc&tier=1");
        OutputString = OutputString + "<b>T1 Black:</b> Price:  " + APIData.data[0].price + "; Fee: " + APIData.data[0].fee + "; Full price: " + APIData.data[0].full_price + "&nbsp; &nbsp; &nbsp; &nbsp;" ;
        */

        //T1 Ochre
        /*Output('Find price data for T1 ochre jewels.....');
        APIData = await GetRAPIData("bazaar/jewels/offers/?color_name=OCHRE&max_price=100&min_price=0.00&page=1&sort_by=full_price&sort_dir=asc&tier=1");
        OutputString = OutputString + "<b>T1 Ochre:</b> Price:  " + APIData.data[0].price + "; Fee: " + APIData.data[0].fee + "; Full price: " + APIData.data[0].full_price + "<br>";
        */

         //T1 Grey
       /* Output('Find price data for T1 grey jewels.....');
        APIData = await GetRAPIData("bazaar/jewels/offers/?color_name=GREY&max_price=100&min_price=0.00&page=1&sort_by=full_price&sort_dir=asc&tier=1");
        OutputString = OutputString + "<b>T1 Grey:</b> Price:  " + APIData.data[0].price + "; Fee: " + APIData.data[0].fee + "; Full price: " + APIData.data[0].full_price + "&nbsp; &nbsp; &nbsp; &nbsp;";
        */

        //T1 Blue
        /*Output('Find price data for T1 blue jewels.....');
        APIData = await GetRAPIData("bazaar/jewels/offers/?color_name=BLUE&max_price=100&min_price=0.00&page=1&sort_by=full_price&sort_dir=asc&tier=1");
        OutputString = OutputString + "<b>T1 Blue:</b> Price:  " + APIData.data[0].price + "; Fee: " + APIData.data[0].fee + "; Full price: " + APIData.data[0].full_price + "<br>";
        */

        //T1 Green
        /*Output('Find price data for T1 green jewels.....');
        APIData = await GetRAPIData("bazaar/jewels/offers/?color_name=GREEN&max_price=100&min_price=0.00&page=1&sort_by=full_price&sort_dir=asc&tier=1");
        OutputString = OutputString + "<b>T1 Green:</b> Price:  " + APIData.data[0].price + "; Fee: " + APIData.data[0].fee + "; Full price: " + APIData.data[0].full_price + "&nbsp; &nbsp; &nbsp; &nbsp;";
        */

        //T1 Sandy
        /*Output('Find price data for T1 sandy jewels.....');
        APIData = await GetRAPIData("bazaar/jewels/offers/?color_name=SANDY&max_price=100&min_price=0.00&page=1&sort_by=full_price&sort_dir=asc&tier=1");
        OutputString = OutputString + "<b>T1 Sandy:</b> Price:  " + APIData.data[0].price + "; Fee: " + APIData.data[0].fee + "; Full price: " + APIData.data[0].full_price + "<br>";
        */

        //T1 Yellow
        /*Output('Find price data for T1 yellow jewels.....');
        APIData = await GetRAPIData("bazaar/jewels/offers/?color_name=YELLOW&max_price=100&min_price=0.00&page=1&sort_by=full_price&sort_dir=asc&tier=1");
        OutputString = OutputString + "<b>T1 Yellow:</b> Price:  " + APIData.data[0].price + "; Fee: " + APIData.data[0].fee + "; Full price: " + APIData.data[0].full_price + "&nbsp; &nbsp; &nbsp; &nbsp;";
        */

        //T1 Anthracite
        /*Output('Find price data for T1 anthracite jewels.....');
        APIData = await GetRAPIData("bazaar/jewels/offers/?color_name=ANTHRACITE&max_price=100&min_price=0.00&page=1&sort_by=full_price&sort_dir=asc&tier=1");
        OutputString = OutputString + "<b>T1 Anthracite:</b> Price:  " + APIData.data[0].price + "; Fee: " + APIData.data[0].fee + "; Full price: " + APIData.data[0].full_price;
        */
...
async function FeatureJewelPricesT2(ClearOutputAtStart = 1)
    {
        ...
        */
        //await GetJewelPriceandFee("2","BLACK","all");
         ...
         */
       // await GetJewelPriceandFee("2","OCHRE","all");
        ...
        */
        //await GetJewelPriceandFee("2","GREY","all");
        ...
        */
       // await GetJewelPriceandFee("2","BLUE","all");
        ...
        */
        //await GetJewelPriceandFee("2","GREEN","all");
        ...
        */
        //await GetJewelPriceandFee("2","SANDY","all");
        ...
        */
       // await GetJewelPriceandFee("2","YELLOW","all");
        ...
        */
        //await GetJewelPriceandFee("2","ANTHRACITE","all");
        ...
        */
        //await GetJewelPriceandFee("2","JAMAICA","all");
        ...
        */
        //await GetJewelPriceandFee("2","SUNRISE","all");
        ...
        */
        //await GetJewelPriceandFee("2","SUNSET","all");
        ...
        */
        //await GetJewelPriceandFee("2","PURPLE","all");
        ...
        */
        //await GetJewelPriceandFee("2","ORANGE","all");
...
async function AddSlottingTabData()
{
    if(localStorage.getItem('E2MultiTool_Properties') != null)
    {
      ...
      while(document.querySelectorAll('.MentarSlottingCard_content__3WNbb')[0] == null)
    {
        //console.log("Page not full loaded, wait 300ms");
        await timeout(300);
    }
   ...
   //Output("Test1");
    ...
    if(localStorage.getItem('E2MultiTool_ProfilUpgrade_Slotting') == 1)
    {
        ...
        propertycardsslotting.forEach(element => {
            ...
            // Output("Test2: >" + tmpPropertyLocation + "<");
            ...
            if(element.parentElement.childElementCount == 2)
            {
                ...
                x++;*/
                    ...
                    if(latlong == tmpPropertyLocation)
                    {
                        //Output("Test 3");
                        var TmpDIV = document.createElement ('div');
                        ...
                        if(localStorage.getItem('E2MultiTool_ProfilUpgrade_Slotting_ResData') == 1)
                        {
                            ...
                            if(element2[8] || element2[9] || element2[10] || element2[11] || element2[12])  //If resource exist
                            {
                                ...
                                if(element2[8] == "1"){if(TmpText == ""){TmpText += "Gold(HF)"; }else{TmpText += ", Gold(HF)";}} //Gold
                                if(element2[8] == "-1"){if(TmpText == ""){TmpText += "Gold(UF)"; }else{TmpText += ", Gold(UF)";}} //Gold

                                if(element2[9] == "1"){if(TmpText == ""){TmpText += "Oil(HF)"; }else{TmpText += ", Oil(HF)";}} //Oil
                                if(element2[9] == "-1"){if(TmpText == ""){TmpText += "Oil(UF)"; }else{TmpText += ", Oil(UF)";}} //Oil

                                if(element2[10] == "1"){if(TmpText == ""){TmpText += "Limestone(HF)"; }else{TmpText += ", Limestone(HF)";}} //Limestone
                                if(element2[10] == "-1"){if(TmpText == ""){TmpText += "Limestone(UF)"; }else{TmpText += ", Limestone(UF)";}} //Limestone

                                if(element2[11] == "1"){if(TmpText == ""){TmpText += "Iron-Ore(HF)"; }else{TmpText += ", Iron-Ore(HF)";}} //Iron-Ore
                                if(element2[11] == "-1"){if(TmpText == ""){TmpText += "Iron-Ore(UF)"; }else{TmpText += ", Iron-Ore(UF)";}} //Iron-Ore

                                if(element2[12] == "1"){if(TmpText == ""){TmpText += "Coal(HF)"; }else{TmpText += ", Coal(HF)";}} //Coal
                                if(element2[12] == "-1"){if(TmpText == ""){TmpText += "Coal(UF)"; }else{TmpText += ", Coal(UF)";}} //Coal
