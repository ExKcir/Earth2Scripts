...
async function AddProfilData()
{
        ...
        else
        {
            ...
            if(localStorage.getItem('E2MultiTool_ProfilUpgrade_Profile_SavedData') == "1")
            {
                ...
                DivProfileData.innerHTML += "Saved properties data from:  " + PropertiesDataDate + "<br>(" + MapProperties.length + " properties | " + TileCount + " tiles)<br><br>";
            }
        }
     ...
     propertycard.forEach(element => {
         ...
         MapProperties.forEach(function(element2) {
             ...
             if(element2[0] == TmpPropertyID)
             {
                 ...
                 if(localStorage.getItem('E2MultiTool_ProfilUpgrade_Properties_ID') == "1")
                 {
                     TmpData += "<tr><td style='width: 30%; padding:20px 0px 0px 0px;'>ID:</td><td style='padding:20px 0px 0px 0px;font-size:15px'> " + TmpPropertyID + "</td></tr>";
                 }

                 if(element2[2] == "1" && localStorage.getItem('E2MultiTool_ProfilUpgrade_Properties_Class') == "1") //Show class if T1
                 {
                     TmpData += "<tr><td style='padding:0'>Class: </td><td style='padding:0'>C" + element2[13] + "</td></tr>";
                 }
                 ...
                 if(localStorage.getItem('E2MultiTool_ProfilUpgrade_Properties_ResData') == "1")
                 {
                     ...
                     {
                         TmpData += "<tr><td style='padding:0'>Resources:</td> <td style='padding:0'>";
                         var TmpText = "";
                ...
                //Holo
                 ...
                 {
                     TmpData += "<tr><td style='padding:0'>Holobuilding:</td> <td style='padding:0'>" + element2[15] + "m3</td></tr>";
                 }
                 ...
                 {
                     TmpData += "<tr><td style='padding:0'>Transformed Essence:</td> <td style='padding:0'>" + element2[16] + "</td></tr>";
                 }
...
async function MainFunction()
{
    ...
    ScriptHTML.innerHTML =
        ...
        <div id="E2Multitool" style="border: 8px ridge green; background-color: rgba(51, 170, 51, .3)">
              ...
              <div  style="width:100%;display: block; align-items: stretch; text-align:center; margin-top: -20px; font-size: 16px">
                  ...
                  <div  style="width:25%; text-align:center; float: left">
                       ...
                       <span style="color: black; font-size: 16px">Speed throttling</span>
                       </label>
                       <button id="Button_SpeedThrottlingHelp" style="width:5%; border: 1px solid black; background:lightgrey"> ? </button> <br>

                       <label style="position: relative; display: inline-block; width: 24%; ">
                       <input id="checkbox_profilupgrade" style="opacity: 0; width: 0; height: 0;" type="checkbox">
                       <span style="color: black; font-size: 16px">Profile upgrade</span>
                       </label>
                       <button id="Button_ProfilUpgradeSettings" style="width:10%; border: 1px solid black; background:lightgrey">Settings</button>
...
<div style="display: block; float: left; width: 50%">
                  <div id="ScriptTextOutput" style="width: 100%; height: 355px; text-align:center; background-color: rgba(100, 100, 100,0.8); border: 5px ridge black; overflow: auto; float:left; font-size:16px">
                  <br><br><br><br>
                  <b>
                  ...
                  <div  style="width:25%;  text-align:center; float: right; font-size: 16px";>
<br>
