...
<span style="color: black; font-size: 14px">Ignore singles</span>
    ...
    `;
    document.getElementById("ScriptTextOutput").appendChild(ButtonDIV);
...
*/
     ...
     $("#Button_PropertiesMapGetProperties").click (LoadMapProperties);
...
async function LoadMapProperties()
{
    ...
    do
    {
        ...
        for(var i = 0; i<Object.keys(APIData.results).length; i++)
        {
            ...
            console.log("Speed throttling: Wait 1000ms");
            await timeout(1000);
    ...
    while(IsSuccessful == 0)
    {
        ...
        try{
            ...
            //id, Titel, Tier,size,location,coordinates1,coordinates2, holo,res_gold,res_oil,res_limestone,res_iron,res_coal, class, for sale
            MapProperties[((j*20)+i)] = [APIData.results[i].id, APIData.results[i].description.replaceAll(",", " - "), APIData.results[i].landfield_tier,APIData.results[i].tile_indexes.length,APIData.results[i].location.replaceAll(",", " - "), tmp2, tmp1, APIData.results[i].holobuilding_id,data.gold,data.oil,data.limestone,Object.values(data)[2],data.coal,APIData.results[i].tile_class, APIData.results[i].for_sale];
...
async function FeatureResourcesList()
{
    ...
    var TilesCounters = Array(5).fill(0);
    var TilesCountersT1 = Array(5).fill(0);
    var TilesCountersT2 = Array(5).fill(0);
    var TilesCountersClass1 = Array(5).fill(0);
    var TilesCountersClass2 = Array(5).fill(0);
    var TilesCountersClass3 = Array(5).fill(0);
    var PropertiesCounters = Array(5).fill(0);
    var PropertiesCountersTier1 = Array(5).fill(0);
    var PropertiesCountersTier2 = Array(5).fill(0);
    var PropertiesCountersClass1 = Array(5).fill(0);
    var PropertiesCountersClass2 = Array(5).fill(0);
    var PropertiesCountersClass3 = Array(5).fill(0);
    var Resources = ["<b>Gold properties:</b><br>","<b>Oil properties:</b><br>","<b>Coal properties:</b><br>","<b>Iron-Ore properties:</b><br>","<b>Limestone properties:</b><br>"] //Gold, Oil, Coal, Iron-Ore, Limestone

     Output(`
    <br>
    <button id="Button_FeatureResourcesListGetData" style="width:30%; border: 1px solid black; background:lightgrey">Load/update properties data</button><br>
    <br>`);
    ...
    if(localStorage.getItem('E2MultiTool_Properties') == null)
    {
       Output(`<br><br><b>No properties data found.<br>Please load/update properties data first!`);
    }
    else
    {
        MapProperties = JSON.parse(localStorage.getItem('E2MultiTool_Properties'));
       ...
       var MapPropertiesSorted = MapProperties.sort(sortTilesSizes);
        ...
        //ClearOutput();
         for(var x = 0; x<=4; x++)
         {
             Output(Resources[x] + "<b>------------------------------------------------------------</b><br>Total: " + PropertiesCounters[x] + " properties | " + TilesCounters[x] + " tiles <br>" +
