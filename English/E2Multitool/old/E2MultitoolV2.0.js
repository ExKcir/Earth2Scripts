...
do
{
     ...
     var APIData = await GetAPIData("my/holobuildings/?limit=10offset=" + (j*10));
     //Output((j*100));
    ...
    for(var i = 0; i<Object.keys(APIData.results).length; i++)
    {
        //console.log(Object.keys(APIData.results[i].slotted_jewel_set).length);
         ClearOutput();
        Output((j*10)+(i+1) + '. holobuilding analyzed');
        ...
        `<div style="border: 5px solid red;">
              ...
              <div  style="width:100%;display: flex; align-items: stretch;  text-align:center; ">
                  ...
                  <div  style="width:25%; text-align:center; float: left">
                     ...
                     <!--
                       <button id="Button_JewelCounterColours" style="width:40%; border: 1px solid black; background:lightgrey">Jewel counter (Colours)</button>
                       <button id="Button_JewelCounterColoursHelp" style="width:5%; border: 1px solid black; background:lightgrey"> ? </button> <br> -->

                  </div>


                  <div id="ScriptTextOutput" style="width: 50%; height: 200px; text-align:center; background:grey; border: 2px solid blue; overflow: auto;">
                  <br>
