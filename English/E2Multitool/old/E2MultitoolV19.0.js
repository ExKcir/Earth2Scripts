...
*/
    ...
    do
    {
        ...
        //Load every property of page
        for(i = 0; i<Object.keys(APIData.landfields).length; i++)
        {
            ...
            MapProperties.forEach(function(element)
            {
                if(APIData.landfields[i].id == element[0])
                {
                    //Add data
                    element[17] = APIData.landfields[i].epl;
                    element[18] = parseFloat(APIData.landfields[i].purchaseValue);
                    element[19] = parseFloat(APIData.landfields[i].currentValue);

                    element[20] = APIData.landfields[i].purchasedAt.replace('T',' ');
