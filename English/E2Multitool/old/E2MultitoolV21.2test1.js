 ...
 if(localStorage.getItem('E2MultiTool_PropertiesDataDate') != null)
   {
       ...
       csvContent += "ID,titel,tier,tiles,location,latitude,longitude, holobuilding ID,res_gold,res_oil,res_limestone,res_iron,res_coal, class, for sale, holo space (m3), transformed essence, EPL, purchase price, current value, purchase date, generated x times LIT, LIT amount\r\n";
