...
*/
   ...
   ProfileTrackerData.push([tmpdate.getFullYear() + "-" + (tmpdate.getMonth()+1) + "-" + tmpdate.getDate() + " " + tmpdate.getHours() + ":" + tmpdate.getMinutes(),
    ...
    TmpTotalCoalHFTiles,TmpTotalCoalUFTiles, TmpTotalCoalHFProperties,TmpTotalCoalUFProperties,TmpTotalPurchaseValue,TmpTotalTradingValue/*, TmpTotalSystemValue*/ ]);
...
async function FeatureProfileTracker()
{
    ...
    Output('<div id="TabsDiv" style="width: 100%;"><div id="Tab_ProfileWorth" style="width: 25%; float:left;">Profile worth</div><div id="Tab_TilesAndProperties" style="width: 25%;float:left;">Tiles & Properties</div><div id="Tab_Resources" style="width: 25%; float:left;">Resources</div><div id="Tab_Other" style="width: 25%; float:left;">Other</div></div>');
    ...
    // Coal HF tiles, Coal UF tiles, Coal HF properties, Coal UF properties [35]
       ...
       var SystemWorthValues = [];
        ...
        CurrentWorthValues.push(element[8]);
        PurchaseWorthValues.push(element[36]);
        TradingWorthValues.push(element[37]);
        ...
        Output('<br><canvas id="Chart1" style="width:100%; height: 85%;"></canvas>');
        ...
        <div id="E2Multitool" style="border: 8px ridge green; background-color: rgb(186,222,186)">
              ...
              <div  style="width:100%;display: block; align-items: stretch; text-align:center; margin-top: -20px; font-size: 14px">
                  ...
                  <div  style="width:25%; text-align:center; float: left">
                       ...
                       <button id="Button_RaidDataHelp" style="width:5%; border: 1px solid black; background:lightgrey"> ? </button>&nbsp; &nbsp;<br>
