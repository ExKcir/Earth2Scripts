...
*/
    ...
    do
    {
        ...
        {
            Output("Error: Cant get more property data for properties of page: " + j);
        }
        else
        {
            //Load every property of page
