...
async function AddProfilData()
{
        ...
        else
        {
            ...
            if(localStorage.getItem('E2MultiTool_ProfilUpgrade_Profile_SavedData') == "1")
            {
                DivProfileData.innerHTML += "<br><br><b style='color: white'>Data:</b> <hr style='width: 100%;border-top: 2px dashed lightgrey;'>";
