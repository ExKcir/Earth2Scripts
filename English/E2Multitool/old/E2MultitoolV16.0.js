...
*/
            ...
            //id, Titel, Tier [2],size,location,coordinates1,coordinates2, holo,res_gold,res_oil,res_limestone,res_iron,res_coal, class[13], for sale, holo m3 [15], transformed essence [16], epl[17], purchase price [18], currentValue [19], purchasedat, got lit x times, toal lit generated [21]
            MapProperties[((j*100)+i)] = [APIData.results[i].id, APIData.results[i].description.replace(/[&\/\\#,+()$~%.'":*?<>{}]/g, ''), APIData.results[i].landfield_tier,APIData.results[i].tile_indexes.length,APIData.results[i].location.replaceAll(",", " - "), tmp2, tmp1, APIData.results[i].holobuilding_id,data.gold,data.oil,data.limestone,Object.values(data)[2],data.coal,APIData.results[i].tile_class, APIData.results[i].for_sale, null, APIData.results[i].claimed_essence_balance, null, null, null, null, 0, 0];
