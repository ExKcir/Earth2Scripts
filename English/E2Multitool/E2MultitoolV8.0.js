    ...
    var TotalWithdrawlsAmount = 0;
     ...
     ClearOutput();
        ...
        do
        {
            ...
            var APIData2 = await GetAPIData("my/balance_changes/?balance_change_type=WITHDRAWAL&limit=100&offset=" + (i*100));
            ...
            {
                TotalWithdrawlsAmount += APIData2.results[m].amount;
                WithdrawlsList = WithdrawlsList + APIData2.results[jm].created_display + ":&nbsp; &nbsp;" + APIData2.results[m].amount + '<br>';
            }
