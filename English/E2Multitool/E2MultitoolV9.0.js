...
<div style="display: block; float: left; width: 50%">
                  <div id="ScriptTextOutput" style="width: 100%; height: 250px; text-align:center; background-color: rgba(100, 100, 100,0.8); border: 5px ridge black; overflow: auto; float:left">
                  <br><br><br>
                  <b>
