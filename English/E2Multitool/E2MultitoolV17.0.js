...
do
{
    ...
    for(var i = 0; i<Object.keys(APIData.results).length; i++)
    {
        ...
        Output('<span style="display: inline-block; width: 20%;">' + HolosTotal + '. HB "' + APIData.results[i].name + '" on: </span><span style="display: inline-block; width: 50%;"> <a style="color: darkblue" href="https://app.earth2.io/#propertyInfo/' + APIData2.id + '">' + EntitiesHtml(APIData2.description) + '</a> (T' + APIData2.landfield_tier + ';C' + APIData2.tile_class + ';' + APIData2.tile_indexes.length +' tiles) </span> &nbsp; &nbsp; &nbsp;' + APIData.results[i].total_volume + ' m3');
