            ...
            do
            {
                ...
                for(var l = 0; l<Object.keys(APIData2.results).length; l++)
                {
                    ...
                    for(var i = 0; i<Object.keys(APIData.results).length; i++)
                    {
                        ...
                        //Bugfix:
                        if(APIData.results[i].linked_object.id == null || APIData2.results[l].linked_object.id == null)
                        {
                            if(APIData.results[i].linked_object.id == null)
                            {
                                Output("Error 1: Property #" +(i+1));
                            }

                            if(APIData2.results[l].linked_object.id == null)
                            {
...
async function FeatureDepositsAndWithdrawalData()
{
    ...
    var TotalWithdrawlsAmount = 0;
    var TotalWithdrawlsAmountFee = 0;
     ...
     ClearOutput();
        ...
        do
        {
            ...
            for(var m = 0; j<Object.keys(APIData2.results).length; m++)
            {
                if(APIData2.results[m].linked_object.status == "COMPLETE")
                {
                    TotalWithdrawlsAmount += APIData2.results[m].linked_object.amount;
                    TotalWithdrawlsAmountFee += APIData2.results[m].amount;
                    WithdrawlsList = WithdrawlsList + APIData2.results[m].created_display + ":&nbsp; &nbsp;Amount(incl. fee): " + APIData2.results[m].linked_object.amount + '&nbsp; &nbsp;Fee: ' + APIData2.results[m].amount + '<br>';
                }
            }
            ...
            ClearOutput();
            Output("<b>Deposits:</b><br>" + DepositsList + "<br><b>Withdrawals:</b><br>" + WithdrawlsList);
            Output("------------------------------------------------<br>Total deposits amount: " + TotalDepositsAmount.toFixed(2) + "<br>Total withdrawals amount: " + TotalWithdrawlsAmount.toFixed(2));
            Output("Total withdrawals fees amount: " + TotalWithdrawlsAmountFee.toFixed(2) + "<br>Total withdrawals amount without fees: " + (TotalWithdrawlsAmount.toFixed(2) - TotalWithdrawlsAmountFee.toFixed(2)));
            ScrollOutput();
            ScriptIsWorking(0);
}
...
async function FeatureRefIncomeCalc()
{
        ...
        do
        {
            ...
            for(var j = 0; j<Object.keys(APIData.results).length; j++)
            {
                ...
                RefCodeIncomeList = RefCodeIncomeList + APIData.results[j].created_display + ":&nbsp; &nbsp;&nbsp; &nbsp;" + APIData.results[j].amount.toFixed(2) + '&nbsp; &nbsp;<span style="display: inline-block; width: 30%;"> Property: ' + APIData.results[j].linked_object.description + '</span>&nbsp; &nbsp;<a style="color: darkblue" href="https://app.earth2.io/#propertyInfo/' + APIData.results[j].linked_object.id + '">LINK to property</a><br>';
            }
        ...
        ClearOutput();
        Output("<b>Referral code income:</b><br>" + RefCodeIncomeList);
        Output("------------------------------------------------ <br> Total income: " + TotalRefCodeIncomeAmount.toFixed(2));
        ...
        `<div id="E2Multitool" style="border: 8px ridge green; background-color: rgba(51, 170, 51, .3)">
              ...
              <div  style="width:100%;display: block; align-items: stretch;  text-align:center; ">
                  ...
                  <div  style="width:25%; text-align:center; float: left">
                       ...
                       <button id="Button_LITData" style="width:40%; border: 1px solid black; background:lightgrey">LIT data</button>
                       <button id="Button_LITDataHelp" style="width:5%; border: 1px solid black; background:lightgrey"> ? </button> &nbsp; &nbsp;
                       ...
                       <button id="Button_RefIncomeCalcHelp" style="width:5%; border: 1px solid black; background:lightgrey"> ? </button> <br>
...
<br>
<br>
Version: ` + version + `<br>You can download the latest version here: <a style="color: darkblue" href="https://github.com/ExKcir/Earth2Scripts/tree/main/English/E2Multitool">Github E2Multitool</a>
                  </div>
